      ...
      request.post({
          ...
          if (body.ok) {
            res.render('result', {
              ...
              message: 'Thank you for signing up, please fill in the <a href="https://join.slack.com/t/accord-project/shared_invite/zt-l0w252bn-GEe9VW~zLdM6FvjCI5nNEQ">Slack form</a>',
