      ...
      request.post({
          ...
          if (body.ok) {
            res.render('result', {
              ...
              message: 'Thank you for signing up, please fill in the <a href="https://join.slack.com/t/accord-project/shared_invite/zt-hej4q3ps-I1G2uSfKUhDMvcFKRggXGw">Slack form</a>',
